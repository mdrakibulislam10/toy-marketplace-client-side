...
const PhotoGallery = () => {
    ...
    const images = [
        "https://t4.ftcdn.net/jpg/01/67/07/79/360_F_167077974_33Gs0e2ovXd25ZBMDIN7Hc5ze1FjJ6fD.webp",
    ...
    return (
        <section className="mb-16 overflow-x-hidden">
            ...
            <div className="flex flex-wrap justify-center gap-4">
                {
                    images.map((img, i) =>
                        <img data-aos="flip-up" data-aos-duration="1000" className="w-96 h-60 rounded" key={i} src={img} alt="" />
                    )
                }
            </div>
        </section>
